...
agentic flow calls the selected LLM API for planning and answer generation, but data access stays
bounded: it resolves player names from warehouse-backed search context, asks for
